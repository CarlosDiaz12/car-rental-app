...
import { CreateEditFuelTypeComponent } from './components/create-edit-fuel-type/create-edit-fuel-type.component';
@Component({
...
export class FuelTypeComponent implements OnInit {
  ...
  constructor(private service: FuelTypeService, public dialog: MatDialog) {}
  ngOnInit(): void {
    this.loadList();
  }
  ...
  add(): void {
    ...
    const dialogRef = this.dialog.open(CreateEditFuelTypeComponent, {
      maxWidth: '500px',
      maxHeight: '400px',
      data: {
        description: '',
